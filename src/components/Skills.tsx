...
const SkillCard: React.FC<{ skill: Skill; index: number }> = ({ skill, index }) => {
  return (
    <AnimatedSection 
      animation="slide-up" 
      delay={0.1 * index}
      className="glass-card p-6 flex flex-col h-full transition-all duration-300 hover:shadow-lg"
    >
...
const Skills: React.FC<SkillProps> = ({ className }) => {
  return (
    <section id="skills" className={cn("py-20 md:py-32 bg-techgray", className)}>
